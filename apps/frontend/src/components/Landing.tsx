              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full rounded-none border border-white/15 px-4 py-2 text-sm text-white/70"
                  >
                    Dashboard
                  </button>
                </>
                ...
                <>
                  <button
                    ...
                    className="w-full rounded-none px-4 py-2 text-sm text-white/40"
                  >
                    Sign in
                  </button>
                  <button
                    ...
                    className="w-full rounded-none bg-white px-4 py-2 text-sm font-medium text-[#0A0A0A]"
                  >
                    Get started
                  </button>
                </>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-3 text-sm text-white/30">
            No signup forms, no scheduling — just your GitHub profile and a
            microphone.
          </p>
        </div>
        <div
          ref={ref}
          className="mt-16 grid gap-px overflow-hidden border border-white/[0.06] bg-white/[0.06] sm:grid-cols-2 lg:grid-cols-3"
        >
    ...
    <section className="border-t border-white/[0.06] px-6 py-24 md:py-32">
      <div className="mx-auto max-w-5xl">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-3 text-sm text-white/30">
            From zero to your first interview in under a minute.
          </p>
        </div>
  ...
  const testimonials = [
    {
      ...
      quote:
        "The AI asked about my Rust projects specifically. It felt like talking to a real interviewer who'd read my code.",
    },
    {
      name: "Marcus Johnson",
      ...
      quote:
        "The instant feedback helped me identify weak spots I didn't know I had. Landed my dream role two weeks later.",
    },
    {
      name: "Priya Patel",
      ...
      quote:
        "The voice-based format made the real interview feel familiar. Practicing at 2 AM was a game-changer.",
    },
  ];
    ...
    <section className="border-t border-white/[0.06] px-6 py-24 md:py-32">
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-3 text-sm text-white/30">
            Join hundreds who've used InterviewDost to prepare.
          </p>
        </div>
